...
export class RolesUserRolesEntity1648224223012 implements MigrationInterface {
    name = 'RolesUserRolesEntity1648224223012'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "user_roles" DROP CONSTRAINT "REL_13380e7efec83468d73fc37938"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "user_roles" DROP CONSTRAINT "FK_472b25323af01488f1f66a06b67"`);
        await queryRunner.query(`ALTER TABLE "user_roles" ADD CONSTRAINT "REL_13380e7efec83468d73fc37938" UNIQUE ("rolesId")`);
